...
Partial Class Setup_AddBuildings
            ...
            Try
                ...
                If maxIDReader.Read() Then
                    While maxIDReader.Read
                        If CType(maxIDReader.Item("BuildingID").ToString, Double) > maxID Then
                            maxID = CType(maxIDReader.Item("BuildingID").ToString, Double)
                        End If
                    End While

                    'Sets the parameter for an Insert depending if any IDs exist or not
                    sqlBuildings.InsertParameters.Item("BuildingID").DefaultValue = maxID + 1
                Else
                    sqlBuildings.InsertParameters.Item("BuildingID").DefaultValue = maxID
                End If
    ...
    Protected Sub btnContinue_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnContinue.Click
        ...
        If buildingsActive.Read() = False Then
            lblResult.Text = "There are no buildings with a status of 'Active' or none exist. Please add a new building or change an already existing building's status to continue."
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        title.Text = "Initial Setup: Add Buildings"
        ...
        buildingsActive = CType(sqlBuildingsActive.Select(DataSourceSelectArguments.Empty), SqlDataReader)
    End Sub
End Class
